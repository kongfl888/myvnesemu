...
void	CNetPlayDlg::AddRecentPort( LPCSTR lpszPort )
{
	...
	::strcpy_s( Config.netplay.szRecentPort[0], sizeof(Config.netplay.szRecentPort[0]), lpszPort );
	if( !bFound ) {
...
void	CNetPlayDlg::AddRecentHost( LPCSTR lpszHost )
{
	...
	::strcpy_s( Config.netplay.szRecentHost[0], sizeof(Config.netplay.szRecentHost[0]), lpszHost );
	if( !bFound ) {
