...
void	CDirectDraw::nx_scanlines_16bpp(LPBYTE lpRdr, LPBYTE lpDlt, DDSURFACEDESC2& ddsd, BOOL bForceWrite)
{
	// Pre-Rendering
	Render16bpp(lpRdr, lpDlt);
	...
	Scanlines(srcPtr, srcPitch, dstPtr, dstPitch, width, height);
}

void	CDirectDraw::nx_scanlines_32bpp(LPBYTE lpRdr, LPBYTE lpDlt, DDSURFACEDESC2& ddsd, BOOL bForceWrite)
{
	// Pre-Rendering
	Render32bpp(lpRdr, lpDlt);
	...
	Scanlines32(srcPtr, src1, dstPtr, dst1, width, height);
}


void	CDirectDraw::nx_tvlines_16bpp(LPBYTE lpRdr, LPBYTE lpDlt, DDSURFACEDESC2& ddsd, BOOL bForceWrite)
{
	// Pre-Rendering
	Render16bpp(lpRdr, lpDlt);
	...
	ScanlinesTV(srcPtr, srcPitch, dstPtr, dstPitch, width, height);
}

void	CDirectDraw::nx_tvlines_32bpp(LPBYTE lpRdr, LPBYTE lpDlt, DDSURFACEDESC2& ddsd, BOOL bForceWrite)
{
	// Pre-Rendering
	Render32bpp(lpRdr, lpDlt);
	...
	ScanlinesTV32(srcPtr, src1, dstPtr, dst1, width, height);
}

void	CDirectDraw::nx_pixelate_16bpp(LPBYTE lpRdr, LPBYTE lpDlt, DDSURFACEDESC2& ddsd, BOOL bForceWrite)
{
	// Pre-Rendering
	Render16bpp(lpRdr, lpDlt);
	...
	Pixelate16(srcPtr, srcPitch, dstPtr, dstPitch, width, height);
}

void	CDirectDraw::nx_pixelate_32bpp(LPBYTE lpRdr, LPBYTE lpDlt, DDSURFACEDESC2& ddsd, BOOL bForceWrite)
{
	// Pre-Rendering
	Render32bpp(lpRdr, lpDlt);
	...
	Pixelate32(srcPtr, src1, dstPtr, dst1, width, height);
}

void	CDirectDraw::nx_admame2x_16bpp(LPBYTE lpRdr, LPBYTE lpDlt, DDSURFACEDESC2& ddsd, BOOL bForceWrite)
{
	// Pre-Rendering
	Render16bpp(lpRdr, lpDlt);
	...
	AdMame2x(srcPtr, srcPitch, dstPtr, dstPitch, width, height);
}

void	CDirectDraw::nx_admame2x_32bpp(LPBYTE lpRdr, LPBYTE lpDlt, DDSURFACEDESC2& ddsd, BOOL bForceWrite)
{
	// Pre-Rendering
	Render32bpp(lpRdr, lpDlt);
